...
//  Needs owner to touch it when first rezzed to start the setup process
//  Added a dark mode toggle in the config notecard so you can have either light or dark screen
//  Removed   TIME_OFFSET=  from config notecard as not used now
//  Added DEBUG option to config notecard
//
// New strings
...
// -----------------------------------------
//
float   VERSION = 5.8;    // 27 September 2022
...
string ImageURL_W = "quintonia.net/images/logo/qexw.png";   // for white background
string ImageURL_B = "quintonia.net/images/logo/qexb.png";   // for black background
string BASEURL;
string BASEIMAGEURL;
//
...
messageScreen(string msg)
{
    ...
    if (useScreen == TRUE)
    {
        ...
        //
        // Display Quintonia Exchange logo
